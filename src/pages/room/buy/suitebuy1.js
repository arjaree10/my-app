                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" value="2000.00 บาท" disabled/>
                            </div>
                        </div>
                    </div>

                    <div className="text-end mt-4">
                        <Link to="/suite"><button className="btn btn-danger me-2" onClick={handleBack}>กลับ</button></Link >
