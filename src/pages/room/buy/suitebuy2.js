                    ...
                    <div className="row mb-4 mt-4 text-start">
                        ...
                        <div className="col-md-6 d-flex justify-content-end">
                            <img 
                                ...
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhOzrKw4ZcJEh-A8eT9RjSLDNltajkE9x8hw&s" 
                                alt="Hotel Room"
                            />
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" value="2500.00 บาท" disabled/>
                            </div>
                        </div>
                    </div>
